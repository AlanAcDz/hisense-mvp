...
export const STAGE_RENDER_LONG_EDGE_PX = 1920
export const STAGE_RENDER_TARGET_FPS = 30
export const BACKGROUND_LAYER_INTERVAL_MS = 100
export const SHIRT_RENDER_PIXEL_RATIO = 1
export const DETECTION_INTERVAL_MS = 40
export const DETECTION_INPUT_LONG_EDGE_PX = 256
